...
"""
# 导入所有技能模块
from skills.docker_management_skill import SKILL_NAME as docker_skill_name, SKILL_DESCRIPTION as docker_skill_description, SKILL_FUNCTIONS as docker_skill_functions
...
from skills.docker_management import get_docker_containers, get_container_status, start_container, stop_container, restart_container, get_container_logs, get_docker_images
from skills.docker_management import docker_management_skill as docker_management
